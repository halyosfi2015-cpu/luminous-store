              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <h2 className="mt-1 text-base font-bold text-gray-900 line-clamp-1 transition-colors duration-300 group-hover:text-primary">
                      {bundle.nameAr}
                    </h2>
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {bundle.occasion.map((oc) => (
                        <span
                          key={oc}
                          className="rounded-pill bg-primary/10 px-2.5 py-1 text-[10px] font-bold text-primary"
                        >
                          {OCCASION_AR[oc] ?? oc}
                        </span>
                      ))}
