...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "For hygiene and safety reasons, beauty and skincare products cannot be returned or exchanged unless they arrive damaged. Device products can be returned if unused, unopened, and in their original condition.",
    answerAr: "حرصاً على سلامتكم، لا يمكن إرجاع أو استبدال منتجات التجميل والعناية إلا إذا وصلت تالفة. أما منتجات الأجهزة فيمكن إرجاعها بشرط أن تكون غير مستخدمة ولم تُفتح وبحالتها الأصلية.",
    category: "Returns",
    categoryAr: "الإرجاع",
  },
  {
