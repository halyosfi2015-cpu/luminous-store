              ...
              <div className="relative aspect-square w-full overflow-hidden bg-muted-bg">
                {product.gallery[0] && (
                  <Image
                    ...
                    fill
                    unoptimized
                    className="object-cover transition-transform duration-500 ease-out-smooth group-hover:scale-110"
                  />
                )}
                <span className="absolute start-2 top-2 inline-flex items-center gap-1 rounded-pill bg-success px-2 py-0.5 text-[10px] font-bold text-white shadow-card">
                  <Sparkles size={10} />
                  جديد
                </span>
              </div>
